#code for complete application of hotel-management-system
...
label1 = Label(my,text="WELCOME TO",font=myFont,bg='#83A5E5').place(x=335,y=0)
label2 = Label(my,text="HOTEL MANAGEMENT SYSTEM",font=myFont,bg='#83A5E5').place(x=180,y=50)
label3 = Label(my,text="Made by Manish").place(x=840,y=730)
#----------- main project------------------------------------------------------------------------------------------------------------------
def mainroot():
	root = Tk()
	...
	tf_label = Label(top_frame,text='Hotel Management System',font='msserif 33',fg='black',bg='#ff0',height=70)
	...
	#-----------------------------------------------------------------
		nl = Label(b_frame,text='Made by Manish',fg='black',bg='gray91',font='msserif 8')
	...
	def staff():
		...
		Label(emp1inf,text="Mr. Manish Singh",bg='white',fg="Grey",font='msserif 10').place(x=60,y=37)
		Label(emp1inf,text="Extention : 025",bg='white',fg="Grey",font='msserif 10').place(x=60,y=59)
		Label(emp1inf,text="Mail : manager@radisson.com",bg='white',fg="Grey",font='msserif 10').place(x=60,y=83)
		...
		Label(emp1inf,text="Mail : customer@radisson.com",bg='white',fg="Grey",font='msserif 10').place(x=45,y=83)	
		emp1inf.pack_propagate(False)
		...
		Label(emp1inf,text="Mail : restaurant@radisson.com",bg='white',fg="Grey",font='msserif 10').place(x=72,y=83)	
		emp1inf.pack_propagate(False)
		...
		Label(emp1inf,text="Mail : roomservice@radisson.com",bg='white',fg="Grey",font='msserif 10').place(x=55,y=83)	
		emp1inf.pack_propagate(False)
	...
	def reserve():
		...
		Label(b_frame,text='Personal Information',font='msserif 15',bg='#ff0').place(x=225,y=0)
		...
		Label(b_frame,text='Contact Information',font='msserif 15',bg='#ff0').place(x=225,y=90)
		...
		Label(b_frame,text='Reservation Information',font='msserif 15',bg='#ff0').place(x=210,y=175)
		...
		def booking():
			if fn.get() == 'First Name' or ln.get() == 'Last Name' or cn.get() == 'Contact Number *' or em.get() == 'Email' or ad.get() == "Guest's Address" or noc.get() == 'Number of Children' or noa.get() == 'Number of Adults' or nod.get() == 'Number of Days of Stay' or roomn.get() == 'Enter Room Number':
				...
				temp = cur.fetchone()
				if temp[0] == 'Reserved':
					messagebox.showwarning('Room is Reserved','Room number '+str(roomn.get())+' is AlReserved')
				else:
					payroot = Tk()
		...
		def unreserve():
			if (roomn.get() == 'Enter Room Number') or (roomn.get()==''):
				...
				con.commit()
		#--------------------------------------------------------right side---------------------------------------------------
		Label(b_frame,text='Filter',font='msserif 20',bg='#ff0').place(x=850,y=0)
